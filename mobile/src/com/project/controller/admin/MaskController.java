 ...
 * 技术QQ：2511251392
 */
@ControllerBind(controllerKey="/admin/mask", viewPath="/admin/mask")
public class MaskController extends BaseController{
	...
	public void index() throws Exception{
		...
		String sWhere="from db_mask m left join db_shop s on m.shop_id=s.id where m.status!=? and s.status!=?";
