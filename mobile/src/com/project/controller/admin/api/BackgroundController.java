 ...
 * 技术QQ：2511251392
 */
@ControllerBind(controllerKey = "/admin/api/background")
public class BackgroundController extends BaseController{
	...
	public void type() throws Exception{
		...
		setAttr("list", list);
		List<Record> background_list=Db.find("select b.*,t.title type_title from db_background b left join db_type t on b.type_id=t.id where b.status=? and t.status=? and b.shop_id is null order by b.create_date desc", Background.STATUS_ENABLE, Type.STATUS_ENABLE);
