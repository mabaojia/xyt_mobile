 ...
 * 技术QQ：2511251392
 */
@ControllerBind(controllerKey = "/admin/api/material")
public class MaterialController extends BaseController{
	...
	public void type() throws Exception{
		...
		setAttr("list", list);
		List<Record> material_list=Db.find("select m.*,t.title type_title from db_material m left join db_type t on m.type_id=t.id where m.status=? and t.status=? and m.shop_id is null order by m.create_date desc", Material.STATUS_ENABLE, Type.STATUS_ENABLE);
